...
function getContribution(event, withData = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const records = yield _Models_1.Record.findAll({
            ...
            where: {
                [sequelize_1.Op.or]: [{
                        action: {
                            [sequelize_1.Op.or]: ['createEvent', 'updateEventStatus', 'updateEventDetail'],
                        },
                        target: event.id,
                    },
                    event.headerImage ? {
                        action: {
                            [sequelize_1.Op.or]: ['createEventHeaderImage', 'updateEventHeaderImage'],
                        },
