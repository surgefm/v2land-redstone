...
function getEventId(eventName, clientName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof name === 'number')
            return name;
        if (!lodash_1.default.isNaN(+name))
            return +name;
        ...
        const event = yield _Models_1.Event.findOne({
            ...
            where: {
                name,
                ownerId: yield ClientService.getClientId(username),
            },
        });
        if (!event)
            return null;
        yield RedisService.set(redisKey, event.id);
        return event.id;
    });
}
