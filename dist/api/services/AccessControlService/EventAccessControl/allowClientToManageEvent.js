...
function allowClientToManageEvent(clientId, eventId, by) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, disallowClientToViewEvent_1.default)(clientId, eventId);
        yield (0, disallowClientToEditEvent_1.default)(clientId, eventId);
        if (by) {
        ...
        return (0, operations_1.addUserRoles)(clientId, yield (0, getEventRoles_1.getEventManageRole)(eventId));
    });
}
exports.default = allowClientToManageEvent;

//# sourceMappingURL=allowClientToManageEvent.js.map
