...
function removeCurator(tagId, curatorId, by) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _Models_1.sequelize.transaction((transaction) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield existingTagCurator.destroy({ transaction });
            yield AccessControlService.disallowClientToManageTag(curatorId, tagId);
        }));
        return existingTagCurator;
    });
}
exports.default = removeCurator;

//# sourceMappingURL=removeCurator.js.map
