...
class WeeklyMode extends _Types_1.NotificationMode {
    constructor() {
        super(...arguments);
        this.name = 'weekly';
        this.nickname = '每月一次的定时提醒';
        this.needNews = false;
    ...
    getTemplate({ notification, event, stack }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let message = `${event.name} 发来了每周一次的定时提醒，`;
            message += stack
                ? `它的最新进展为 ${stack.title}。`
                : '该事件至今尚无进展。';
            return {
...
exports.WeeklyMode = WeeklyMode;
exports.default = new WeeklyMode();

//# sourceMappingURL=WeeklyMode.js.map
