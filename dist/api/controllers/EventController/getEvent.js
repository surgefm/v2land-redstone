...
function getEvent(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!commit && !showLatest) {
            ...
            const event = yield _Services_1.EventService.findEvent(eventId, { eventOnly: true, plain: true });
            if (!event)
                return res.status(404).json({ message: '未找到该事件' });
            return res.status(200).json(Object.assign(Object.assign({}, event), { stacks: [], offshelfNews: [], roles,
                starCount,
                subscriptionCount,
                curations }));
        }
