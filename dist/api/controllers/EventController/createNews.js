...
function createNews(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _Models_1.sequelize.transaction((transaction) => __awaiter(this, void 0, void 0, function* () {
            ...
            _Services_1.SiteService.findOrCreateBySourceName(data.source, data.url)
                .then((site) => __awaiter(this, void 0, void 0, function* () {
                if (site) {
                    yield _Models_1.News.update({ siteId: site.id }, { where: { id: news.id, siteId: null } });
                }
            }))
