...
exports.updateStackSchema = {
    ...
    order: zod_1.z.number().optional().describe('New display order for the stack (supports negative values)'),
};
...
exports.updateEventSchema = {
    ...
    status: zod_1.z.enum(['pending', 'admitted', 'hidden', 'removed']).optional().describe('New status for the event'),
};
