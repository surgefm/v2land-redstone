...
function removeManager(socket, server) {
    socket.on('remove manager', (eventId, clientId, cb = () => { }) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield _Services_1.AccessControlService.disallowClientToManageEvent(clientId, eventId);
        socket.in((0, getRoomName_1.default)(eventId)).emit('remove manager', { eventId, clientId });
...
exports.default = removeManager;

//# sourceMappingURL=removeManager.js.map
