...
function makeCommit(socket) {
    socket.on('make commit', (eventId, summary, description, cb = () => { }) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const commit = yield _Services_1.CommitService.makeCommit(eventId, clientId, summary, { description });
            if (commit) {
                socket.in((0, getRoomName_1.default)(eventId)).emit('make commit', { commit });
            }
            cb(null, { commit });
        }
        catch (err) {
