...
function removeEditor(socket, server) {
    socket.on('remove editor', (eventId, clientId, cb = () => { }) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield _Services_1.AccessControlService.disallowClientToEditEvent(clientId, eventId);
        socket.in((0, getRoomName_1.default)(eventId)).emit('remove editor', { eventId, clientId });
...
exports.default = removeEditor;

//# sourceMappingURL=removeEditor.js.map
