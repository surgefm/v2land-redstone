...
function liftServer(app) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { ensureAllNewsHaveSiteIcons } = yield Promise.resolve().then(() => __importStar(require('@Services/SiteService')));
            ensureAllNewsHaveSiteIcons().catch((err) => console.warn('SiteService startup backfill failed:', err.message));
        }
        catch (err) {
