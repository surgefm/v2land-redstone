...
- 不使用带感情色彩的动词（如"出手""亮剑""打脸"）
- 不使用暗示对错的因果表述（如"咎由自取""自食其果"）
- 当引用一方的表态时，明确标注为该方立场（如"中方称……""日方表示……"）
...
### 来源平衡要求
- 涉及国际争端或多方分歧的事件，每个 stack 应尽量包含不同立场的来源
- 例如中日争端：既要有中文媒体/中方官方来源，也要有国际通讯社或日方视角的报道
- 例如国内争议事件：既要有官方表态，也要有当事方或独立媒体的报道
- 至少做到：每个 stack 不少于 2 条来源，且不全部来自同一立场阵营
